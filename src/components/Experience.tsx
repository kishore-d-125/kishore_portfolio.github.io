  ...
  const experiences = [
    {
      ...
      description: "Built AI/ML-based speech recognition models in Python, focusing on natural language processing and machine learning algorithms.",
    ...
    },
    {
      ...
      description: "Developed real-time web applications using AngularJS framework, gaining hands-on experience in frontend development.",
      color: "from-blue-500 to-cyan-500"
    }
  ];

  return (
    <section id="experience" className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-slate-50 to-purple-50">
